  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          <h2 className="text-xl font-bold text-gray-900">Test Case Generator</h2>
          <p className="text-gray-500 text-sm">Generate structured test cases for any Guidewire module</p>
        </div>
      </div>
      ...
      <div className="card space-y-5">
        ...
        <div>
          <label className="label">
            Specific Scenario / Context <span className="text-gray-400 font-normal">(optional)</span>
          </label>
          <textarea
